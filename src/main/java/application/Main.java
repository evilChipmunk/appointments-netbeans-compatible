...
public class Main extends Application {
    ...
    private static void showErrorDialog(Throwable e) {
        ...
        if(e.getMessage() == "The owner node needs to be associated with a window"){
            return; //some funkiness with the appointmentlinecontrol -> appointmentcontrol but app still works
        }
        ...
        try{
          ...
          //  ValidationException vex = (ValidationException) ex.getTargetException();
            ...
            errorMsg = unPackError(e);// e.getMessage();
            errorMsg += "\r\n" + e.getStackTrace().toString();
        }
